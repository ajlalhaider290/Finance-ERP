...
import { InvoiceDocumentDetail } from '../../../interface';

export const InvoiceDocumentViewDetails = ({ data }: { data?: InvoiceDocumentDetail }) => {
  return (
    <>
      {data && (
    ...
    : (typeof data?.fileName === 'object' && data?.fileName !== null
        ...
        <div className="grid grid-cols-3 py-3 border-b">
          ...
          <div className="col-span-2 text-sm">{data?.invoiceDocumentsUploadedLabel || data?.uploadedBy || '-'}</div>
        </div>
